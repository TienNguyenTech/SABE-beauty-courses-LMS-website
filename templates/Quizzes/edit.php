 ...
 */
?>
<h1 class="h3 mb-2 text-gray-800">Edit quiz for <?= $course->course_name ?></h1>
<?= $this->Form->create($quiz, ['class' => 'text-gray-800']) ?>

<?= $this->Form->control('quiz_title', [
    'label' => [
...
<?= $this->Form->button(__('Update quiz'), ['id' => 'submitButton', 'class' => 'btn btn-primary', 'style' => 'margin-top: 10px']) ?>
<?= $this->Form->end() ?>
