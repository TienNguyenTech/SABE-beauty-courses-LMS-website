...
<!--                        --><?php //= $this->Html->link($enquiry->enquiry_seen ? 'Mark as Unread' : 'Mark as Read', ['action' => 'toggle', $enquiry->enquiry_id], ['class' => 'btn btn-primary mark-read-btn']) ?>
                        <?= $this->Form->postLink('Unarchive', ['action' => 'unarchive', $enquiry->enquiry_id], ['class' => 'btn btn-warning archive-btn', 'confirm' => 'Are you sure you want to unarchive this enquiry?']) ?>
                    </td>
                </tr>
            <?php endforeach; ?>
            </tbody>
