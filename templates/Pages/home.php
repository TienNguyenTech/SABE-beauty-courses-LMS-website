...
<style>
    body {
        ...
        /* Light green background color for the entire page */
    }
</style>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 text-center">
                    <div class="single-product-item">
                        ...
                        <p class="product-price"><span>Master the techniques needed <br> to elevate your lash and brow
                                artistry </span> 199$ </p>
                        <!--<a href="cart.html" class="cart-btn"><i class="fas fa-shopping-cart"></i> Add to Cart</a>-->
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 offset-md-3 offset-lg-0 text-center">
                    <div class="single-product-item">
                        ...
                        <p class="product-price"><span>Precision and Expertise: Achieve Waxing excellence</span> 499$
                        </p>
                        <!--<a href="cart.html" class="cart-btn"><i class="fas fa-shopping-cart"></i> Add to Cart</a>-->
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row clearfix">
                            ...
                            <div class="image">
                                <div class="price-box">
                                    <div class="inner-price">
                                        <span class="price">
                                            <strong>New!</strong> <br> Custom plan
                                        </span>
                                    </div>
                                </div>
                        ...
                        <div class="content-column col-lg-6">
                            ...
                            <div class="text">Experience a training program that is designed to enhance your natural
                                strengths, whole improving any upon pre-existing skills and talents.</div>
                            <!--Countdown Timer-->
                            <div class="time-counter">
                                <div class="time-countdown clearfix" data-countdown="2024/9/01">
                                ...
                                <div class="single-testimonial-slider">
                                    ...
                                    <div class="client-meta">
                                        ...
                                        <p class="testimonial-body">
                                            ...
                                            architecto beatae vitae dict eaque ipsa quae ab illo inventore Sed ut
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="abt-text">
                                ...
                                <p>Etiam vulputate ut augue vel sodales. In sollicitudin neque et massa porttitor
                                    vestibulum ac vel nisi. Vestibulum placerat eget dolor sit amet posuere. In ut dolor
                                    aliquet, aliquet sapien sed, interdum velit. Nam eu molestie lorem.</p>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sapiente facilis illo
                                    repellat veritatis minus, et labore minima mollitia qui ducimus.</p>
