            ...
            <div class="row">
                <div class="col-lg-12 col-sm-12 text-center">
                    <div class="main-menu-wrap">
                        <!-- logo -->
                        <div class="site-logo" style="z-index: 10; pointer-events: auto; position: relative;">
                            <?= $this->Html->link(
                        ...
                        <!-- menu start -->
                        <nav class="main-menu"
                            style="position: relative; top: 0; -webkit-transform: translateY(10%); -ms-transform: translateY(10%); transform: translateY(10%);">
                            <ul>
...
--------------------------------------------------------------*/
    ...
    <section id="instagram-section">
        ...
        <div class="row d-flex justify-content-between" style="max-width: 1320px; margin: auto">
            <!-- First row -->
            <blockquote class="instagram-media" data-instgrm-permalink="<?= $this->ContentBlock->text('instagram-1') ?>"
                ...
                <div style="padding:16px;"> <a href="<?= $this->ContentBlock->text('instagram-1') ?>"
                    ...
                    <p
                        ...
                        <a href="https://www.instagram.com/reel/C8WB6uuPvZz/?utm_source=ig_embed&amp;utm_campaign=loading"
                            ...
                            target="_blank">A post shared by Beauty therapy courses with Adelaide Beauty and Education
                            (@adelaidebeautyandeducation)</a></p>
                </div>
            </blockquote>
            <script async src="//www.instagram.com/embed.js"></script>
            <blockquote class="instagram-media" data-instgrm-permalink="<?= $this->ContentBlock->text('instagram-2') ?>"
                data-instgrm-version="14"
                style=" background:#FFF; border:0; border-radius:3px; box-shadow:0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15); margin: 10px; max-width:420px; min-width:326px; padding:0; width:99.375%; width:-webkit-calc(100% - 2px); width:calc(100% - 2px);">
